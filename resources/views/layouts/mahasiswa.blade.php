...
<head>
    ...
    <title>@yield('title', 'Mahasiswa Dashboard') - Presensi Kampus</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-xl font-bold">Portal Mahasiswa</span>
                </div>
                <div class="flex items-center gap-4">
    ...
    <div class="flex">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed md:relative md:translate-x-0 z-10 w-64 bg-white dark:bg-[#0F172A] border-r border-gray-200 dark:border-[#F8FAFC]/20 min-h-[calc(100vh-64px)] transition-transform duration-300 ease-in-out">
            <nav class="p-4 space-y-2">
                ...
                @endphp
                <a href="/mahasiswa/dashboard" class="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors border border-transparent dark:border-[#F8FAFC] hover:border-blue-500 dark:hover:border-blue-500 {{ $route == 'mahasiswa.dashboard' ? 'bg-blue-50 dark:bg-[#1E3A8A]/30 text-blue-600 dark:text-[#0062FF]' : 'text-slate-600 dark:text-[#F8FAFC]/80 hover:bg-slate-50 dark:hover:bg-[#1E293B] hover:text-slate-900 dark:hover:text-[#F8FAFC]' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                    Jadwal Hari Ini
                </a>
                <a href="/mahasiswa/pindai" class="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors border border-transparent dark:border-[#F8FAFC] hover:border-blue-500 dark:hover:border-blue-500 {{ $route == 'mahasiswa.pindai' ? 'bg-blue-50 dark:bg-[#1E3A8A]/30 text-blue-600 dark:text-[#0062FF]' : 'text-slate-600 dark:text-[#F8FAFC]/80 hover:bg-slate-50 dark:hover:bg-[#1E293B] hover:text-slate-900 dark:hover:text-[#F8FAFC]' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                    Pindai Presensi
                </a>
                <a href="/mahasiswa/semua-jadwal" class="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors border border-transparent dark:border-[#F8FAFC] hover:border-blue-500 dark:hover:border-blue-500 {{ $route == 'mahasiswa.semua_jadwal' ? 'bg-blue-50 dark:bg-[#1E3A8A]/30 text-blue-600 dark:text-[#0062FF]' : 'text-slate-600 dark:text-[#F8FAFC]/80 hover:bg-slate-50 dark:hover:bg-[#1E293B] hover:text-slate-900 dark:hover:text-[#F8FAFC]' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    Semua Jadwal
                </a>
                <a href="/mahasiswa/riwayat" class="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors border border-transparent dark:border-[#F8FAFC] hover:border-blue-500 dark:hover:border-blue-500 {{ $route == 'mahasiswa.riwayat' ? 'bg-blue-50 dark:bg-[#1E3A8A]/30 text-blue-600 dark:text-[#0062FF]' : 'text-slate-600 dark:text-[#F8FAFC]/80 hover:bg-slate-50 dark:hover:bg-[#1E293B] hover:text-slate-900 dark:hover:text-[#F8FAFC]' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    Riwayat Presensi
                </a>
                <a href="/mahasiswa/peminatan" class="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors border border-transparent dark:border-[#F8FAFC] hover:border-blue-500 dark:hover:border-blue-500 {{ $route == 'mahasiswa.peminatan' ? 'bg-blue-50 dark:bg-[#1E3A8A]/30 text-blue-600 dark:text-[#0062FF]' : 'text-slate-600 dark:text-[#F8FAFC]/80 hover:bg-slate-50 dark:hover:bg-[#1E293B] hover:text-slate-900 dark:hover:text-[#F8FAFC]' }}">
